  ...
  return (
    <div className="auth-page">
      <div className="auth-visual">
        <img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1000&q=85" alt="Fashion" />
        <div className="auth-visual-overlay">
          <div className="auth-visual-logo">TERRA<span>COTTA</span></div>
          <div className="auth-visual-text">
            <h2>Join the TERRACOTTA<br />Community</h2>
            <p>Exclusive access to premium collections, early drops, and member-only deals.</p>
            <div className="auth-visual-dots"><span /><span className="active" /><span /></div>
          </div>
        </div>
      </div>
      ...
      <div className="auth-form-side">
        <div className="auth-form-wrap">
          <div className="auth-card">
            ...
            <p className="auth-subheading">Join thousands of fashion-forward individuals today.</p>
                ...
                <div className="form-group">
                  ...
                  <div className="form-input-wrap">
                    <input id="firstName" name="firstName" type="text" className="form-input"
                      placeholder="Priya" value={form.firstName} onChange={handleChange} required />
                  </div>
                </div>
                <div className="form-group">
              ...
              <div className="form-group">
                ...
                <div className="form-input-wrap">
                  <input id="password" name="password" type={showPw ? 'text' : 'password'}
                    className="form-input has-toggle" placeholder="Min. 8 characters"
